...
"")
        ...
        self.exitBTN = QtWidgets.QPushButton(parent=self.gridLayoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.exitBTN.sizePolicy().hasHeightForWidth())
        self.exitBTN.setSizePolicy(sizePolicy)
        self.exitBTN.setMinimumSize(QtCore.QSize(270, 50))
        self.exitBTN.setMaximumSize(QtCore.QSize(270, 50))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(255, 255, 255))
        brush.setStyle(QtCore.Qt.BrushStyle.SolidPattern)
        palette.setBrush(QtGui.QPalette.ColorGroup.Active, QtGui.QPalette.ColorRole.WindowText, brush)
        ...
        self.MenuGridLayout.addWidget(self.exitBTN, 5, 0, 1, 1)
        ...
        self.pushButton_4.setMinimumSize(QtCore.QSize(270, 50))
        self.pushButton_4.setMaximumSize(QtCore.QSize(270, 50))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(255, 255, 255))
        brush.setStyle(QtCore.Qt.BrushStyle.SolidPattern)
        palette.setBrush(QtGui.QPalette.ColorGroup.Active, QtGui.QPalette.ColorRole.WindowText, brush)
        ...
        self.MenuGridLayout.addWidget(self.pushButton_4, 6, 0, 1, 1)
